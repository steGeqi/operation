<template>
  <div class="dv-decoration-12"
       :ref="ref">
    <svg :width="width"
         :height="height">
      <defs>
        <g :id="gId">
          <path :stroke="pathColor[i]"
      ...
      <g v-if="showSplitLine">
        <polyline v-for="p in splitLinePoints"
                  :key="p"
                  :points="p"
                  :stroke="mergedColor[1]"
                  :stroke-width="0.5"
...
import { uuid, fade } from '../../utils/index'
import { getCircleRadianPoint } from '../../utils/charts/util'
